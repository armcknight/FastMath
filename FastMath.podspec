#
#  Be sure to run `pod spec lint FastMath.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "http://github.com/tworingsoft/fastmath"
  ...
  s.source       = { :git => "http://github.com/tworingsoft/fastmath.git", :tag => "#{s.version}" }
